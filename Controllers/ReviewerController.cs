...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewerController :Controller
    {
        ...
        [ProducesResponseType(400)]
        public IActionResult CreateReviewer([FromQuery] int ownerId, [FromQuery] int catId, [FromBody] ReviewerDto reviewerCreate)
        {
        ...
        //_________________________________deleter review
